"""
Editor de texto criado de acordo com a proposta passada em SEMB2
"""
#Bibliotecas
import sys, os
...
class AppDemo(QMainWindow):
    def __init__(self):
        ...
        # Open, save, saveAs
        open_file_action = QAction(QIcon('./Icons/open_files.ico'), 'Open File...', self)
...
sys.exit(app.exec_())
"""
Referenciado ao tutorial do YouTube:
https://www.youtube.com/watch?v=zx9OFYy5Xhs&t=141s
"""